...
def _seed_calls(admin_id, coordinator_id):
    ...
    db.session.add_all([
        ...
        CallForSubmission(
            title='LCC — Mobility Scholarships',
            full_name='Mobilumo stipendijos kultūros ir meno kūrėjams — Lietuvos kultūros taryba',
            venue_type='funding', deadline_status='fixed',
            area='individual artist mobility, international residencies, conferences, creative exchange — all art forms',
            known_deadline=date(2026, 6, 30),
            source_url='https://ltkt.lt/kurejams/konkursai',
            description='Lithuanian Culture Council mobility scholarships for individual culture and arts creators. Several rounds per year, each covering a different activity quarter. Current round (round 5): open May 1–June 30, 2026 for activities starting Sep–Dec 2026. Apply via LKT IS 2.0 at lktis.ltkt.lt.',
            guidelines='Individual artists and creators resident in Lithuania. Authenticate via e-government gateway (el. valdžios vartai). Review program conditions (sąlygos) before applying. Amount varies by destination and duration.',
            recurrence='annual',
            created_by_id=coordinator_id),
        CallForSubmission(
            title='LCC — Interdisciplinary Projects',
            full_name='Tarpsritiniai projektai — Lietuvos kultūros taryba',
            venue_type='funding', deadline_status='seasonal-check',
            area='professional artistic creation and dissemination — events, publishing, critical discourse, networking, co-productions, all art forms',
            source_url='https://ltkt.lt/organizacijoms/konkursai/205',
            description='Annual competitive grant for organisations supporting professional creation and its dissemination in Lithuania. Covers events, publishing, critical analysis, networking, and co-productions. Five priority tracks: youth arts education, regional access, cultural continuity, innovation, cultural identity. Artistic quality carries the highest evaluation weight (30 pts).',
            guidelines='Legal entities registered in Lithuania. Applications through LKT IS system. Select one of five priority tracks at submission. Deadline typically autumn each year.',
            recurrence='annual',
            created_by_id=coordinator_id),
        CallForSubmission(
            title='LCC — Strategic International Events',
            full_name='Strateginis tarptautinių renginių finansavimas — Lietuvos kultūros taryba',
            venue_type='funding', deadline_status='seasonal-check',
            area='established international cultural events held in Lithuania — all art forms (excluding cinema)',
            source_url='https://ltkt.lt/organizacijoms/konkursai/589',
            description='Multi-year strategic funding for established international arts events in Lithuania. Grants of €40,000–€140,000/year (up to 70% of budget). Events must have run at least 3 times and enjoy international recognition. Presents Lithuanian and foreign art at the highest professional level.',
            guidelines='Registered legal entities in Lithuania (excluding government bodies). Events must be professional, international, multi-edition, and internationally recognized. Annual selection competition. Contact: aleksandra.chackeviciute@ltkt.lt.',
            recurrence='annual',
            created_by_id=coordinator_id),
        CallForSubmission(
            title='LCC — Networking / Tinklaveika',
            full_name='Tinklaveika — Lietuvos kultūros taryba (CCI Networking Grants)',
            venue_type='funding', deadline_status='seasonal-check',
            area='cultural and creative industries (CCI) — networking, export, international promotion, entrepreneurship',
            source_url='https://ltkt.lt/organizacijoms/konkursai/944',
            description='Grant program for cultural and creative industries organisations to develop networks, promote Lithuanian CCI internationally, and participate in international sectoral events. Total budget €200,000/year. Max grant €20,000 (75% funding intensity). Vilnius, Kaunas, Klaipėda-registered or EU/EEA entities.',
            guidelines='Legal entities in Vilnius, Kaunas, or Klaipėda (or EU/EEA). Min project €3,333 / min request €2,500 / max €20,000. Applications typically open summer for following-year activities. 2026 activities deadline was Sept 9, 2025.',
            recurrence='annual',
            created_by_id=coordinator_id),
        # ── Vilnius Municipality ──
        CallForSubmission(
            title='Vilnius — Culture Support Programs',
            full_name='Kultūros rėmimo programų projektų konkursas — Vilniaus miesto savivaldybė',
            venue_type='funding', deadline_status='seasonal-check',
            ...
            source_url='https://vilnius.lt/savivaldybe/svietimas-kultura-ir-sportas/kultura/kulturos-remimo-programu-projektu-konkursas',
            description='Annual Vilnius City Municipality competition for cultural projects across 11 program categories. Total annual budget ~€1.5 million. Max grant €7,000–€25,000 per project (up to 80% of project value). 2026 round: 599 applications, 239 funded. Apply via konkursai.vilnius.lt. Watch for autumn call for the following year.',
            guidelines='Individuals and organisations carrying out cultural activities in Vilnius. Apply via konkursai.vilnius.lt portal. Results typically announced February–March. Contact: kulturos@vilnius.lt.',
            recurrence='annual',
            created_by_id=coordinator_id),
        CallForSubmission(
            title='Vilnius — Multi-year Org Funding',
            full_name='Vilniaus miesto kultūros organizacijų finansavimo konkursas 2026–2028',
            venue_type='funding', deadline_status='unknown-current',
            area='established cultural organisations in Vilnius — all art forms',
            source_url='https://konkursai.vilnius.lt/konkursai/2026-2028-metu-vilniaus-miesto-kulturos-organizaciju-finansavimo-konkursas',
            description='Three-year strategic funding (2026–2028) for established cultural organisations in Vilnius Municipality. Provides multi-year grants for organisational sustainability and programming. Check konkursai.vilnius.lt for next cycle.',
            guidelines='Established cultural organisations registered and active in Vilnius. Applications through konkursai.vilnius.lt portal.',
            recurrence='none',
            created_by_id=coordinator_id),
        # ── Nordic-Baltic ──
        CallForSubmission(
            title='NordPlus Horizontal',
            ...
            known_deadline=date(2027, 2, 1),
            source_url='https://nordplusonline.org/',
            description='Nordic Council of Ministers program for cross-sectoral projects and networks across Nordic and Baltic countries (Lithuania eligible). Covers culture, civil society, and education. Annual deadline in early February. 2026 deadline was February 2, 2026; next round estimated February 2027.',
            guidelines='Any institution or organisation in Nordic-Baltic countries working with education and lifelong learning; cultural/civil society organisations can join as co-applicants. Apply via nordplusonline.org.',
            recurrence='annual',
            created_by_id=coordinator_id),
        CallForSubmission(
            title='Nordic-Baltic Mobility for Culture',
            full_name='Nordic-Baltic Mobility Programme for Culture — Nordic Culture Point',
            venue_type='funding', deadline_status='fixed',
            area='professional artist and cultural practitioner mobility — exhibitions, collaboration, conferences, research visits, guest performances — Nordic and Baltic region',
            known_deadline=date(2026, 9, 18),
            source_url='https://www.nkk.org/en/mobility-funding/',
            description='Individual mobility funding for professional artists and cultural practitioners in Nordic or Baltic countries (Lithuania eligible). Covers travel and stays up to 14 days within the Nordic-Baltic region for collaboration, exhibitions, conferences, research, or guest performances. Current round open August 18–September 18, 2026.',
            guidelines='Professional artists and cultural practitioners residing in Nordic or Baltic countries. Individual applications only — not institutional. Requires invitation letter from host. No domestic or extra-regional travel. Apply via applicant.nordiskkulturkontakt.org.',
            recurrence='annual',
            created_by_id=coordinator_id),
    ])
    db.session.commit()
